...
const MiniGames = ({ windowDimensions }) => {
  ...
  const images = {
    ...
    hiddenObjects:
      process.env.PUBLIC_URL + '/images/mini-games/hidden-objects.png',
    jigsawPuzzle:
      process.env.PUBLIC_URL + '/images/mini-games/jigsaw-puzzle.png',
    quiz: process.env.PUBLIC_URL + '/images/mini-games/quiz.png',
  };

  const video = {
    miniGames: process.env.PUBLIC_URL + '/video/mini-games.mp4',
  };
    ...
    <div className='mini-games'>
      ...
      {windowDimensions.width > 767.5 ? (
        <>
          ...
          >
            <source src={video.miniGames} type='video/mp4' />
          </video>
        ...
        <>
          ...
          <div className='mobile-box hidden-pc' data-aos='fade-up'>
            {/* <video
              autoPlay
              muted
              loop
